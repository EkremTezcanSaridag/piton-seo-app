...
<div align="center">
  ...
  <br/>
  <p><i>Kaynak girişi ve içerik ayarlarının yapıldığı ekran[cite: 1].</i></p>
  
  <h3>2. Google SERP Önizlemesi</h3>
  <img src="./public/screenshots/bloglisteleri.png" width="800" alt="SERP Preview" />
  <br/>
  <p><i>Meta verilerin arama motoru sonuçlarındaki görünümü[cite: 1].</i></p>

  <h3>3. PDF Rapor Çıktısı</h3>
  <img src="./public/screenshots/olusanpdf.png" width="800" alt="PDF Raporu" />
  <br/>
  <p><i>Üretilen içeriğin profesyonel rapor formatı.</i></p>
</div>
